  ...
  return (
    <section className="my-16 bg-white text-gray-800 rounded-lg p-6">
      <div className="text-center mb-12">
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 max-w-6xl mx-auto p-4  cursor:pointer">
          {[
            { label: "Fruits", icon: "🍎" },
            ...
            <div
              key={index}
              className="bg-gray-100 rounded-xl  hover:bg-green-200 transition p-4 flex flex-col justify-between items-center text-center border border-gray-100   "
            >
              <Link href="/shop">
                {" "}
                <span className="text-3xl">{item.icon}</span>
                <span className="text-green-800 font-semibold mt-2">
                  {item.label}
                </span>
              </Link>
            </div>
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          We source directly from local farmers to ensure the freshest produce
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-gray-100 rounded-lg p-6 text-center shadow-md">
          ...
          <p className="text-gray-600">
            All our fruits are grown without harmful pesticides or chemicals.
          </p>
        </div>
        ...
        <div className="bg-gray-100 rounded-lg p-6 text-center shadow-md">
          ...
          <p className="text-gray-600">
            We deliver within 24 hours to ensure maximum freshness.
          </p>
        </div>
